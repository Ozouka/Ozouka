...
public class LoginDialog {
	...
	/**
	 * Permet l'affichage de la fenêtre de connexion
	...
	/**
	 * Permet à l'utilisateur d'interagir avec le dialogue du controleur de connexion
	...
	/**
	 * Cherche l'employé par l'identifiant et le mot de passe
	 * @param login L'identifiant de connexion
	 * @param password Le mot de passe
	 * @return L'employé ayant l'identifiant et le mot de passe entrés
	 */
